...
if __name__ == '__main__':
    ...
    model_path = "/home/caoxinyu/Arbitrary-scale/liif-main/save/_train_edsr-baseline-lte/epoch-best.pth"
    init_model = models.make(torch.load(model_path)['model'], load_sd=True).cuda()
