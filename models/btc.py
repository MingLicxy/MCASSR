...
################################ BTC ##################################
"""
BTC的基本思想与LTE最为相近, LTE基于傅里叶函数而BTC基于B-spline函数
"""
@register('btc')
class BTC(nn.Module):
    ...
    def __init__(self, encoder_spec, imnet_spec=None, hidden_dim=256, basis_ord=3):
        ...
        self.basis_ord = basis_ord #TODO B-spline阶数
    ...
    def query_rgb(self, coord, cell=None):
        ...
        for vx in vx_lst:
            for vy in vy_lst:
                ...
                q_knot = q_knot * dilation #TODO 逐元素相乘
