...
class Spatial_Attention(nn.Module):
    ...
    def __init__(self, dim, idx, split_size=[8,8], dim_out=None, num_heads=6, attn_drop=0., proj_drop=0., qk_scale=None, position_bias=True):
        ...
        ################################################################################# 
        #TODO  split_size=[8,8]相当于设置window_size=8，而img_size=48可以被8整除
        if idx == 0:
...
class ResidualGroup(nn.Module):
    ...
    def __init__(   self,
                    ...
                    reso,
                    num_heads,
                    split_size=[2,4], #TODO 关键参数相当于设置window_size
                    expansion_factor=4.,
                    qkv_bias=False,
                    qk_scale=None,
                    drop=0.,
...
@register('dat')
def make_dat(no_upsampling=True):
    return DAT()
