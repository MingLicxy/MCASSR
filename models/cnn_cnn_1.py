...
class CNN_CNN_1(nn.Module):
    ...
    def forward_features(self, x):
        ...
        for i in range(self.num_layers): # 4
            x_mam = self.mamba_branch[i](x_mam) # [bs, seq_len, c]
