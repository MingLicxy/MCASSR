...
def local_sampling(x, group_size, unfold_dict, output=0, tp='bhwc'):
    ...
    if output == 1:
        return x_sampled
    #print('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$', x_grouped.shape) # [36, 256, 180]
    #print('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$', x_sampled.shape) # [36, 576, 180]
...
def global_sampling(x, group_size, sample_size, output=0, tp='bhwc'):
    ...
    #print('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@', x.shape) # [4, 180, 48, 48] bchw
    # 进行数据重排
    if output != 1:
        if tp == 'bchw':
    ...
    if output == 1:
        return x_sampled
    #print('#############################################', x_grouped.shape) # [36, 256, 180]
    #print('#############################################', x_sampled.shape) # [16, 576, 180]
    #TODO 要求x_grouped和x_sampled第一维相同
    assert x_grouped.size(0) == x_sampled.size(0)
    return x_grouped, x_sampled