...
@register('rcan')
def make_rcan(n_resgroups=4, n_resblocks=12, n_feats=64, reduction=16,
              scale=1, no_upsampling=False, rgb_range=1):
    args = Namespace()
