    ...
    def __init__(self,
        ...
        if not sparse_flag: # 密集
            self.blocks = nn.ModuleList([HAB_D(dim=dim,
                                            ...
                                            interval = interval,
                                            triangular_flag = 0 if (i%2==0) else 1, # 矩形框三角框交替
...
class CFAT(nn.Module):
    ...
    def __init__(self,
                 ...
                 shift_size = (0, 0, 8, 8, 16, 16, 24, 24),  #changed to tuple 窗口移位参数
                 interval=(0, 2, 0, 2, 0), # 稀疏程度参数
        ...
        for i_layer in range(self.num_layers): #4
            layer = RHAG(dim=embed_dim,
                         ...
                         sparse_flag = 0 if (i_layer % 2 == 0) else 1, # 稀疏密集交替
