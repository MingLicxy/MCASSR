...
class Attention_axial(nn.Module):
    ...
    """
    def __init__(self, dim, resolution, idx, split_size=8, dim_out=None, num_heads=6, attn_drop=0., proj_drop=0., qk_scale=None, position_bias=True):
        super().__init__()
        self.dim = dim
        ...
        #TODO self.resolution=img_size=48; self.split_size=window_size=8
        elif idx == 0:
...
class CATB_axial(nn.Module):
    ...
    def __init__(self, dim, reso, num_heads,
                 split_size=8, shift_size=0, mlp_ratio=4., qkv_bias=False, qk_scale=None,
...
class ResidualGroup(nn.Module):
    ...
    def __init__(   self,
        ...
        #TODO 'CATB_regular'表示自定义分辨率矩形窗口
...
class CAT(nn.Module):
    ...
    def __init__(self,
                ...
                embed_dim=180,
                depth=[2,2,2,2],
                split_size_0 = [0,0,0,0], #TODO 关键参数
                ...
                resi_connection='1conv',
                upsampler='none',
                block_name='CATB_axial', # ['CATB_axial','CATB_regular']
                **kwargs):
        super().__init__()
...
# @register('cat')
# def make_cat(no_upsampling=True):
#     # 声明自定义参数模型
#     # model = CAT(
#     #     upscale=1,
#     #     img_size=48, # 2048可以被64整除
#     #     depth=[2, 2, 2, 2],
#     #     embed_dim=180,
#     #     num_heads=[2, 2, 2, 2],
#     #     split_size_0=[8, 8, 8, 8], #TODO 该参数表示矩形窗口的宽
#     #     split_size_1=[0, 0, 0, 0], #TODO 该参数表示矩形窗口的长，只有在'CATB_regular'有用
#     #     block_name = 'CATB_axial', # # ['CATB_axial','CATB_regular']
#     #     mlp_ratio=2,
#     #     resi_connection='1conv',
#     #     upsampler='none',
...
#         embed_dim=180,
#         num_heads=[2, 2, 2, 2],
#         split_size_0=[4, 4, 4, 4], #TODO 该参数表示矩形窗口的宽
#         split_size_1=[12, 12, 12, 12], #TODO 该参数表示矩形窗口的长，只有在'CATB_regular'有用
#         block_name = 'CATB_regular', # # ['CATB_axial','CATB_regular']
#         mlp_ratio=2,
#         resi_connection='1conv',
#         upsampler='none',
#         )
...
#TODO ACT用于Multi-contrast MRI(RCT)
@register('cat')
def make_cat(no_upsampling=True):
    return CAT(upscale=1,
               img_size=64,
               depth=[6, 6, 6, 6],
               embed_dim=90,
               num_heads=[6, 6, 6, 6],
