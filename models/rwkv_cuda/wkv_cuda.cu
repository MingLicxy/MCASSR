...
#define CHANNEL_SPLIT (512 / 64) // 8
#define EPS (1e-6)
#define TOKEN_SPLIT (512 / CHANNEL_SPLIT) // the number of split tokens 64
...
void cuda_forward(int B, int T, int C, float *w, float *u, float *k, float *v, float *y) {
    // 1024 threads per plock CHANNEL_SPLIT = 512/64 = 8; TOKEN_SPLIT = 512/CHANNEL_SPLIT = 64
